...
void *publish_task(void *arg0){
    ...
    ret |= MQTT_IF_Subscribe(mqttClientHandle, "Topic_DC", MQTT_QOS_0, topic_subscribe_callback);
    ...
    while(1)
    {
        ...
        retrieve_publish_queue(&mqttMessage);
        ...
        MQTT_IF_Publish(mqttClientHandle,
                        mqttMessage.topic,
                        mqttMessage.json_string,
                        strlen(mqttMessage.json_string),
                        MQTT_QOS_0);
